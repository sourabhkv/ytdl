...
if  os.path.exists(os.getcwd()+"\\database"):
    ...
    file5.close()
    file6=open(os.getcwd()+"\\database\\output_temp_vid.txt",'w+')
    file6.write("%(title)s.%(ext)s")
    file6.close()
    file7=open(os.getcwd()+"\\database\\output_temp_playlist.txt",'w+')
...
imgclr = PhotoImage(file = os.getcwd()+"/images/"+"clr2.png")
...
img3 = PhotoImage(file = os.getcwd()+"/images/"+"img3.png")
...
img4 = PhotoImage(file = os.getcwd()+"/images/"+"img4.png")
...
img5 = PhotoImage(file = os.getcwd()+"/images/"+"donatedark.png")
...
img6 = PhotoImage(file = os.getcwd()+"/images/"+"img6.png")
...
img7 = PhotoImage(file = os.getcwd()+"/images/"+"img7.png")
...
img14 = PhotoImage(file = os.getcwd()+"/images/"+"settings.png")
...
image = Image.open(os.getcwd()+"/images/"+"logo.png")
img9 = PhotoImage(file = os.getcwd()+"/images/"+"img9.png")
img10 = PhotoImage(file = os.getcwd()+"/images/"+"img10.png")
img11 = PhotoImage(file = os.getcwd()+"/images/"+"img11.png")
img12 = PhotoImage(file = os.getcwd()+"/images/"+"img12.png")
img13 = PhotoImage(file = os.getcwd()+"/images/"+"img13.png")
imggored = PhotoImage(file=os.getcwd()+"/images/"+"gored.png")
imgdwred = PhotoImage(file=os.getcwd()+"/images/"+"dwred.png")
aboutd=PhotoImage(file=os.getcwd()+"/images/"+"aboutdark.png")
updated=PhotoImage(file=os.getcwd()+"/images/"+"updatedark.png")
githubd=PhotoImage(file=os.getcwd()+"/images/"+"githubdark.png")
terminald=PhotoImage(file=os.getcwd()+"/images/"+"donatelight.png")
supd=PhotoImage(file=os.getcwd()+"/images/"+"supportedwebsitesdark.png")
optionsd=PhotoImage(file=os.getcwd()+"/images/"+"settingsdark.png")
imgclearred = PhotoImage(file=os.getcwd()+"/images/"+"clearred.png")
imgpastered = PhotoImage(file=os.getcwd()+"/images/"+"pastered.png")
imgbrowred = PhotoImage(file=os.getcwd()+"/images/"+"browred.png")
imgthred = PhotoImage(file=os.getcwd()+"/images/"+"thred.png")
resize_image = image.resize((25, 25))
img = ImageTk.PhotoImage(resize_image)
label1 = Label(image=img,bg="#303135")
label1.image = img
label1.place(x=410,y=10)
img8 = PhotoImage(file = os.getcwd()+"/images/"+"browse.png")
...
img0 = PhotoImage(file = os.getcwd()+"/images/"+"paste.png")
...
img1 = PhotoImage(file = os.getcwd()+"/images/"+"clear.png")
...
img2 = PhotoImage(file = os.getcwd()+"/images/"+"go.png")
...
root.iconbitmap(os.getcwd()+"/images/"+'logo.ico')
root.title('Youtube-dl GUI')
root.mainloop()
