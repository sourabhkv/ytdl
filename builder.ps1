...
pip install pytube
.\yt-dlp_X86 -U
pyinstaller --icon=.\ytdl\images\logo.ico -w --hidden-import yt_dlp.compat._legacy ".\ytdl\__main__.py"
New-Item -Path ".\dist\Youtube-dl GUI\images" -ItemType Directory
Copy-Item ".ytdl\images\*.*" -Destination ".\dist\Youtube-dl GUI\images"
